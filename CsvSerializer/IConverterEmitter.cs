...
namespace Csv {
	public interface IConverterEmitter {
		...
		/// </summary>
		void EmitAppendToStringBuilder(ILGenerator gen, LocalBuilder? local, CsvColumnAttribute? attribute);
		...
		/// </summary>
		void EmitDeserialize(ILGenerator gen, LocalBuilder? local, CsvColumnAttribute? attribute);
	}
}
